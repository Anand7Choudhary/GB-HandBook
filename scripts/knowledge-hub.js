...
class KnowledgeHub {
    ...
    checkScrollable() {
        const tagsContainer = this.filterContainer.querySelector('.filter-tags');
        const isScrollable = tagsContainer.scrollWidth > tagsContainer.clientWidth;
        this.filterContainer.classList.toggle('scrollable', isScrollable);
    }
